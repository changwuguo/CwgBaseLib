 ...
 *  @return BCUParameter
 */
-(RACSignal*)getBCUParameter:(NSString*)target parameter:(BCURequest *)bcuRequest;
 ...
 *  @return ConfigResult
 */
-(RACSignal*)BCUControl:(NSString*)target parameter:(BcuControlParameter *)bcuControlParameter;
